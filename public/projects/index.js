...
.then(data=>{
    ...
    for (let i = 0; i < totalProjects; i++) {
        ...
        project_card_front.classList.add("card", "project-card", "project-card-front");
        ...
        project_card_front_img.setAttribute("src",extractor(projects[i]['gsx$projectimage']['$t']));
        ...
        project_card_front_p.innerText = projects[i]["gsx$projectdescription"]["$t"];
        project_card_front.appendChild(project_card_front_p);
        
        var project_card_back = document.createElement("div");
        project_card_back.classList.add("card", "project-card", "project-card-back");
        ...
        project_card_back_items_img.setAttribute("src",extractor(projects[i]['gsx$yourphoto']['$t']));
        project_card_back_items_img.setAttribute("style","border-radius: 50%; width:200px; height:200px;");
        ...
        if(projects[i]["gsx$yourportfoliolinkifyouhave"]["$t"]!=="")
            project_card_back_items_h1_a.href = projects[i]["gsx$yourportfoliolinkifyouhave"]["$t"];
        else
            project_card_back_items_h1_a.removeAttribute("href");
        project_card_back_items_h1_a.innerText = projects[i]["gsx$yourname"]["$t"];
        ...
        if(projects[i]["gsx$githublink"]["$t"]!=="")
            ...
            items_social_github_a.style.display="none";
        ...
        if(projects[i]["gsx$linkedinlink"]["$t"]!=="")
            ...
            items_social_linkedin_a.style.display="none";
        ...
        if(projects[i]["gsx$twitterlink"]["$t"]!=="")
            ...
            items_social_twitter_a.style.display="none";
